...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OTItem.item_no'
        #db.alter_column(u'website_otitem', 'item_no', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
        db.execute(
            'DROP INDEX website_otitem_item_no_like;'
            'ALTER TABLE website_otitem ALTER COLUMN item_no TYPE integer USING (trim(item_no)::integer);'
        )

    def backwards(self, orm):

        # Changing field 'OTItem.item_no'
        db.alter_column(u'website_otitem', 'item_no', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'website.otitem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_no': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
